...
const Footer = () => {
  return (
    <footer className='w-full lg:max-w-screen-md flex flex-col justify-center items-center mx-auto'>
      ...
      <AnimationContainer customClassName='w-full grid place-items-center grid-cols-1 gap-1 lg:gap-4 pb-8 sm:grid-cols-3 mx-3'>
        ...
        <div className='flex flex-col space-y-4'>
          ...
          <ExternalLink href='https://github.com/MananDudhwala'>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' className='w-5 h-5'>
          ...
          <ExternalLink href='https://www.linkedin.com/in/manandudhwala/'>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' className='w-5 h-5'>
        ...
        <div className='flex flex-col space-y-4'>
          ...
          <ExternalLink href='https://manandudhwala.tiiny.site/'>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' className='w-5 h-5'>
